...
{
    f1[0]=dt*D/pow(dx,2)*(f0[1]-2*f0[0]+f0[N-1])+f0[0];
    for(int i=1; i<N-1;i++){
     f1[i] = dt*D/pow(dx,2)*(f0[i+1]-2*f0[i]+f0[i-1])+f0[i];   
    }
    
    f1[N-1]=dt*D/pow(dx,2)*(f0[0]-2*f0[N-1]+f0[N-2])+f0[N-1];
}
//-----------------------------------------------
